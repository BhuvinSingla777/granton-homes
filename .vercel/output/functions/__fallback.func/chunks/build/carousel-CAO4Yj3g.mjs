import { c as createLucideIcon } from './SiteShell-BcMVmoz8.mjs';
import { Q as reactExports, I as jsxRuntimeExports, a as React$1 } from './server-LkwB2fso.mjs';
import { A as ArrowRight } from './arrow-right-B5jP0K4O.mjs';
...
const CarouselContent = reactExports.forwardRef(
  ({ className, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: carouselRef, className: "h-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ref,
        className: cn(
...
export { Carousel as C, CarouselContent as a, CarouselItem as b, ChevronLeft as c, ChevronRight as d, cn as e };
