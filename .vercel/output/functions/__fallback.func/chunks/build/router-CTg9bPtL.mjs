...
const appCss = "/assets/styles-BJoBb8vc.css";
...
const Route$9 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Granton Homes — Luxury Custom Home Builders" },
      { name: "description", content: "Granton Homes designs and builds award-winning luxury custom homes, knock down rebuilds and premium developments across Australia." },
      { property: "og:title", content: "Granton Homes — Luxury Custom Home Builders" },
      { property: "og:description", content: "Award-winning luxury home builder. From bespoke designs to knock down rebuilds." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&family=Montserrat:wght@300;400;500;600;700;800;900&family=Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;1,400&display=swap" },
...
const $$splitComponentImporter$8 = () => import('./virtual-tour-CijS-tjy.mjs');
const Route$8 = createFileRoute("/virtual-tour")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});

const $$splitComponentImporter$7 = () => import('./knock-down-rebuild-CzclWS-z.mjs');
const Route$7 = createFileRoute("/knock-down-rebuild")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});

const $$splitComponentImporter$6 = () => import('./home-designs-DPEXqeGC.mjs');
const Route$6 = createFileRoute("/home-designs")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});

const $$splitComponentImporter$5 = () => import('./gallery-DFt_VDJ-.mjs');
const Route$5 = createFileRoute("/gallery")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});

const $$splitComponentImporter$4 = () => import('./display-homes-DqzrYPDs.mjs');
const Route$4 = createFileRoute("/display-homes")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});

const $$splitComponentImporter$3 = () => import('./developments-Cx9jCdwV.mjs');
const Route$3 = createFileRoute("/developments")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});

const $$splitComponentImporter$2 = () => import('./contact-us-DvuHA7GZ.mjs');
const Route$2 = createFileRoute("/contact-us")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});

const $$splitComponentImporter$1 = () => import('./about-us-xWZPhtz9.mjs');
const Route$1 = createFileRoute("/about-us")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});

const $$splitComponentImporter = () => import('./index-5gPVLXue.mjs');
const Route = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});

const VirtualTourRoute = Route$8.update({
  id: "/virtual-tour",
  path: "/virtual-tour",
  getParentRoute: () => Route$9
});
const KnockDownRebuildRoute = Route$7.update({
  id: "/knock-down-rebuild",
  path: "/knock-down-rebuild",
  getParentRoute: () => Route$9
});
const HomeDesignsRoute = Route$6.update({
  id: "/home-designs",
  path: "/home-designs",
  getParentRoute: () => Route$9
});
...
const DisplayHomesRoute = Route$4.update({
  id: "/display-homes",
  path: "/display-homes",
  getParentRoute: () => Route$9
});
const DevelopmentsRoute = Route$3.update({
  id: "/developments",
  path: "/developments",
  getParentRoute: () => Route$9
});
