...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SiteShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHero, { eyebrow: "Crafting Distinctive Residences", title: "Homes tailored to the way you live.", subtitle: "Award-winning standard designs, custom architecture, and a personalised journey from concept to keys.", image: HERO_IMAGE }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: HERO_IMAGE, alt: "", className: "h-full w-full object-cover" }),
