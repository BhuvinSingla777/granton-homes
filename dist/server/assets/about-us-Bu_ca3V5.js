...
function AboutPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SiteShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHero, { eyebrow: "About Us", title: "A philosophy built on belief and involvement.", subtitle: "Whether you're building on a vacant block or considering a complete knock down rebuild, our process is tailored — so your home reflects your lifestyle, not a template.", image: HERO_IMAGE }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-secondary py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-luxe grid lg:grid-cols-2 gap-14 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[4/5] overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: DISPLAY_LIVING, alt: "Granton Homes interior", loading: "lazy", className: "h-full w-full object-cover" }),
