import { a2 as useRouter, P as reactExports, H as jsxRuntimeExports } from './server-BxxsEqCc.js';
...
const logo = "/assets/granton-logo-DLD8n6a_.png";
...
function Logo({ className = "h-11" }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "isolate block shrink-0", "aria-label": "Granton Homes — Home", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "img",
    {
      ...
      height: 204,
      decoding: "async",
      className: `h-auto w-auto max-h-full object-contain object-left ${className}`
    }
  ) });
}
...
export { Mail as M, PageHero as P, Reveal as R, SiteShell as S, X, Phone as a, createLucideIcon as c };
